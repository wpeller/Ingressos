...
export class LoginComponent extends AppComponentBase implements OnInit {
    ...
    public getAplicacaoIdentityManagerUrl(): string {
        let url = `${AppConsts.urlIdentityManager}${AppConsts.idAplicacaoIdentityManager}`;
        url += `&returnurl=${AppConsts.appBaseUrl}/account/identitymanagerlogin?token=`;
        return url;
    }

    ngOnInit(): void {
        location.href = this.getAplicacaoIdentityManagerUrl();
