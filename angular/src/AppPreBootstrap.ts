...
export class AppPreBootstrap {
    ...
    private static getApplicationConfig(appRootUrl: string, callback: () => void) {
        ...
        XmlHttpRequestHelper.ajax(type, url, customHeaders, null, (result) => {
            ...
            AppConsts.urlIdentityManager = result.urlIdentityManager;
            AppConsts.idAplicacaoIdentityManager = result.idAplicacaoIdentityManager;
            AppConsts.appBaseUrlFormat = result.appBaseUrl;
            AppConsts.remoteServiceBaseUrlFormat = result.remoteServiceBaseUrl;
            AppConsts.localeMappings = result.localeMappings;
            AppConsts.moduloAcesso = result.moduloAcesso;
            
            if (tenancyName == null) {
                AppConsts.appBaseUrl = result.appBaseUrl.replace(AppConsts.tenancyNamePlaceHolderInUrl + '.', '');
                AppConsts.remoteServiceBaseUrl = result.remoteServiceBaseUrl.replace(AppConsts.tenancyNamePlaceHolderInUrl + '.', '');
                AppConsts.ambiente = "Ambiente: " + result.ambiente;
            } else {
