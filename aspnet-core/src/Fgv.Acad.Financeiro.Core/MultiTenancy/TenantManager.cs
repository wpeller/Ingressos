...
using Fgv.Acad.Financeiro.MultiTenancy.Demo;
...
namespace Fgv.Acad.Financeiro.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(FinanceiroConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
