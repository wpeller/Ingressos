...
using Fgv.Acad.Financeiro.Web.Url;
using Newtonsoft.Json.Linq;

namespace Fgv.Acad.Financeiro.Web.Startup
{
    [DependsOn(
        typeof(FinanceiroWebCoreModule)
    )]
    public class FinanceiroWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FinanceiroWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FinanceiroWebHostModule).GetAssembly());
        }
