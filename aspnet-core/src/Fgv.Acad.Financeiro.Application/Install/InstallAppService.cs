...
using Fgv.Acad.Financeiro.Migrations.Seed.Host;
...
namespace Fgv.Acad.Financeiro.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : FinanceiroAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<FinanceiroDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(FinanceiroConsts.ConnectionStringName).Value.ToString();
        }
