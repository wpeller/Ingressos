...
using Fgv.Acad.Financeiro.Authorization.Permissions;
...
using Fgv.Acad.Financeiro.Authorization.Users.Exporting;
...
namespace Fgv.Acad.Financeiro.Authorization.Users
{
    ...
    public class UserAppService : FinanceiroAppServiceBase, IUserAppService
    {
