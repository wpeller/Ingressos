...
using Fgv.Acad.Financeiro.Tenants.Dashboard.Dto;

namespace Fgv.Acad.Financeiro.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : FinanceiroAppServiceBase, ITenantDashboardAppService
    {
