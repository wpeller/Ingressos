...
using Fgv.Acad.Financeiro.IdentityManager;
...
using Fgv.Acad.Financeiro.Web.Models.TokenAuth;
...
namespace Fgv.Acad.Financeiro.Web.Controllers
{
    ...
    public class TokenAuthController : FinanceiroControllerBase
    {
       ...
       // private readonly ILogApiIDEService _logApiIdeService;
        ...
        public async Task<ExternalAuthenticateResultModel> ExternalLoginToken(string token)
        {
            ...
            switch (result.Result)
            {
                case AbpLoginResultType.Success:
                    ...
                    RegistraLogLogin(result.User.Name);
        ...
        public async Task<ExternalAuthenticateResultModel> IdentityManagerLogin(string token)
        {
            ...
            switch (result.Result)
            {
                case AbpLoginResultType.Success:
                    result.User.SetSignInToken();
                    RegistraLogLogin(informacoesToken.User);
        ...
        private void RegistraLogLogin(string usuario)
        {
            var input = new InputRegistraLogLoginDto()
            {
