...
using Fgv.Acad.Financeiro.Web.Authentication.JwtBearer;
using Fgv.Acad.Financeiro.Web.Authentication.TwoFactor;
...
namespace Fgv.Acad.Financeiro.Web
{
    ...
    public class FinanceiroWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FinanceiroWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(FinanceiroApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FinanceiroWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(FinanceiroWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
