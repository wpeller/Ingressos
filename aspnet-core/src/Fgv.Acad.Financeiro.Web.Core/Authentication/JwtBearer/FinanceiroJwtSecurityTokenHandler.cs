...
namespace Fgv.Acad.Financeiro.Web.Authentication.JwtBearer
{
    public class FinanceiroJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public FinanceiroJwtSecurityTokenHandler()
        {
