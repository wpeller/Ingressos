...
namespace Fgv.Acad.Financeiro.Tests.Authorization.Users
{
    public class UserAppService_Link_Tests : UserAppServiceTestBase
    {
        ...
        private async Task<int> CreateTestTenantAndTestUser()
        {
            ...
            {
                ConnectionString = SimpleStringCipher.Instance.Encrypt("Server=localhost; Database=FinanceiroTest_" + Guid.NewGuid().ToString("N") + "; Trusted_Connection=True;")
            };
